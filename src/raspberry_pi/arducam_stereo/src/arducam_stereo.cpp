...
int video_callback(BUFFER* buffer) {
    ...
    if (buffer->length) {
        ...
        if (buffer->flags & MMAL_BUFFER_HEADER_FLAG_CODECSIDEINFO) {
            ...
            if (nFrames_ % 100 == 0) {
                RCLCPP_INFO(arducam->get_logger(), "send Frames");
            }
            ...
            /*     h264_msg.data.insert(h264_msg.data.begin(), &buffer->data[0], */
...
/* class ArducamStereo : public rclcpp::Node { */
/*   public: */
/*     ArducamStereo() : Node("arducam_stereo") { */
...
/*         this->declare_parameter<int>("node_rate_loop", 30); */
/*         this->declare_parameter<int>("width", 2560); */
/*         this->declare_parameter<int>("height", 720); */
/*         this->declare_parameter<int>("scale", 2); */
...
/*         this->declare_parameter<int>("red_gain", 10); */
/*         this->declare_parameter<int>("blue_gain", 50); */

/*         this->get_parameter("node_rate_loop", _node_rate_loop); */
/*         this->get_parameter("width", _width); */
/*         this->get_parameter("height", _height); */
/*         this->get_parameter("scale", _scale); */
...
/*     void start_stream() { */
/*         RCLCPP_INFO(this->get_logger(), "Start video encoding..."); */
/*         res = arducam_set_video_callback(camera_instance, &video_state, video_callback, NULL); */
/*         if (res) { */
/*             RCLCPP_INFO( */
/*                 this->get_logger(), */
/*                 "Failed to start video encoding, probably due to resolution greater than
 * 1920x1080 " */
...
/*             usleep(1000 * 300); */
/*         } */
/*         RCLCPP_INFO(this->get_logger(), "Stop video encoding..."); */
...
int main(int argc, char* argv[]) {
    ...
    RCLCPP_INFO(arducam->get_logger(), "sdfsdfs");
